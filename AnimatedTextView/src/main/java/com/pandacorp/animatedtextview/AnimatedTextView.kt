...
class AnimatedTextView @JvmOverloads constructor(
    ...
    class AnimatedTextDrawable(
        ...
        fun setText(text: CharSequence?, withAnimation: Boolean, moveDown: Boolean) {
            ...
            if (animated) {
                ...
                val onNewPart =
                    RegionCallback { part: CharSequence, _: Int, _: Int ->
                ...
                animator =
                    ValueAnimator.ofFloat(0f.also { t = it }, 1f).apply {
    ...
    private fun setTextSize(textSizeSp: Float) {
        drawable.textSize =
